...
| 2  | **boonya-io-gateway** | 8080 | ✅ | 3 | API网关（路由、鉴权） |
| 3  | **boonya-io-iot** | 8081 | ✅ | 20+ | IoT核心（MQTT、规则引擎、告警） |
| 4  | **boonya-io-minio** | 8082 | ✅ | - | 对象存储（文件上传下载） |
| 5  | **boonya-io-auth** | 8083 | ✅ | 10 | 认证授权（JWT、登录注册） |
| 6  | **boonya-io-analytics** | 8084 | ✅ | 5 | 数据分析（实时数据、趋势） |
| 7  | **boonya-io-ota** | 8085 | ✅ | 15 | OTA升级（固件管理、任务调度） |
| 8  | **boonya-io-device** | 8086 | ✅ | 15+ | 设备管理（注册、心跳、状态） |
| 9  | **frontend/admin** | -    | ✅ | - | 管理后台（Vue 3 + TypeScript） |
| 10 | **frontend/h5** | -    | ✅ | - | 移动端 H5（Vue 3 + TypeScript） |

**总计**：80+ 核心代码文件，100+ API 接口，2 个前端项目
...
- **设备**：http://localhost:8086/swagger-ui.html
- **IoT**：http://localhost:8081/swagger-ui.html
