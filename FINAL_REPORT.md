...
| **boonya-io-minio** | ✅ 已有 | 8082 | 6 | 对象存储（文件上传下载） |
| **boonya-io-auth** | ✅ 完成 | 8083 | 8 | 认证授权（JWT、登录注册） |
| **boonya-io-analytics** | ✅ 完成 | 8084 | 4 | 数据分析（实时数据、趋势） |
| **boonya-io-ota** | ✅ 完成 | 8085 | 11 | OTA升级（固件管理、任务调度） |
| **boonya-io-device** | ✅ 完成 | 8086 | 13 | 设备管理（注册、心跳、状态） |

### 前端模块

| 模块 | 状态 | 技术栈 | 说明 |
|------|------|--------|------|
| **boonya-io-frontend/admin** | ✅ 完成 | Vue 3 + TypeScript | 管理后台 |
| **boonya-io-frontend/h5** | ✅ 完成 | Vue 3 + TypeScript | 移动端 H5 |
