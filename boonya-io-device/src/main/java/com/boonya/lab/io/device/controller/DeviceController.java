...
public class DeviceController {
    ...
    public Result<DeviceResponse> registerDevice(@Valid @RequestBody DeviceRegisterRequest request) {
    ...
    public Result<Void> activateDevice(@PathVariable String deviceId) {
    ...
    public Result<Void> updateHeartbeat(@PathVariable String deviceId) {
    ...
    public Result<DeviceResponse> getDeviceByDeviceId(@PathVariable String deviceId) {
        return Result.success(deviceService.getDeviceResponseByDeviceId(deviceId));
    }

    @GetMapping("/query")
    @Operation(summary = "查询设备列表", description = "分页查询设备列表，支持多条件筛选")
    public Result<PageResult<DeviceResponse>> queryDevices(DeviceQueryRequest request) {
        Page<DeviceResponse> page = deviceService.queryDevices(request);
        PageResult<DeviceResponse> pageResult = PageResult.of(
    ...
    public Result<List<DeviceResponse>> getOnlineDevices() {
        return Result.success(deviceService.getOnlineDevices());
    }

    @GetMapping("/{deviceId}/status")
    @Operation(summary = "获取设备状态", description = "获取指定设备的当前状态")
    public Result<Map<String, String>> getDeviceStatus(@PathVariable String deviceId) {
    ...
    public Result<Void> updateDeviceStatus(@PathVariable Long id, @RequestParam String status) {
